...
trait PlaceholderApi
{
    ...
    private static array $colorMap = [
        ...
        'material_quartz' => TF::MATERIAL_QUARTZ,
        'material_iron' => TF::MATERIAL_IRON,
        'material_netherite' => TF::MATERIAL_NETHERITE,
        'material_redstone' => TF::MATERIAL_REDSTONE,
        'material_copper' => TF::MATERIAL_COPPER,
        'material_gold' => TF::MATERIAL_GOLD,
        'material_emerald' => TF::MATERIAL_EMERALD,
        'material_diamond' => TF::MATERIAL_DIAMOND,
        'material_lapis' => TF::MATERIAL_LAPIS,
        'material_amethyst' => TF::MATERIAL_AMETHYST,
        'material_resin' => TF::MATERIAL_RESIN,
        'bold' => TF::BOLD,
        'italic' => TF::ITALIC,
